...
// provides static rendering (no modifications to source)
...
// provides handbars-based rendering
...
TemplateRenderer.prototype = {  
  ...
  renderTemplate: function(meta, layout, cb) {
    ...
    var newMeta = merge(templateMeta, meta);
...
// manages a single source file and associated renderer
...
// helper functions creates a site
